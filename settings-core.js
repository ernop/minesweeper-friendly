...
const SHOWN_THINGS_OPTIONS = [
  ...
  ['boardMetricFacts', 'board measurements', 'HZiNi, 3BV spread, 0–1 share, and zero-opening coverage in This board'],
  ['exactHZiNi', 'Human ZiNi tablechart', 'times on boards with the same opening-first chord benchmark (HZiNi)'],
  ['workSpreadTable', '3BV-spread tablechart', 'times on boards in the same half-cell 3BV-spread band'],
  ['zeroOneShareTable', '0–1-share tablechart', 'times on boards with exactly the same fraction of safe squares showing zero or one'],
  ['zeroOpeningTable', 'zero-opening-coverage tablechart', 'times on boards with exactly the same fraction of safe squares exposed by opening every zero region'],
